    ...
    return (
        <section className={"w-12/12 sm:w-11/12 md:w-12/12 lg:w-9/12 mx-auto mt-10"}>
            ...
            <div className="w-full text-center">
                <div className="inline-block group relative rounded-full h-70 w-70 sm:h-100 sm:w-100 p-2 bg-gray-700 overflow-hidden transition-transform duration-300 transform hover:scale-110">
